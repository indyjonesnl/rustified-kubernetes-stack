...
NODE_CTR="k0s-rhino-crunfl-cluster"
APISERVER_PORT=26443
...
# deploy flannel-rs. Wait for the apiserver + node object, ensure a PodCIDR (flannel-rs
# reads Node.Spec.PodCIDR), then apply the flannel-rs DaemonSet.
...
PY
echo "PASS: k0s-rhino-crun-flannelrs conformance (rhino datastore + crun OCI + flannel-rs CNI)"
